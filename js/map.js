...
const NPC_FACTION_COLORS = [
  ...
  // 靛蓝（曹魏）— H:215° 暗版玩家蓝，承袭 KOEI 曹魏蓝传统
  { fill:'rgba(18,38,75,0.82)',   film:'rgba(70,105,170,0.20)',  stroke:'rgba(95,130,195,0.70)',  glow:'#4a78b8',  text:'#dbe4f2' },
  // 赭石（刘表系）— H:25° 暗赭橙（沿用）
  { fill:'rgba(78,42,12,0.82)',   film:'rgba(180,110,45,0.20)',  stroke:'rgba(205,135,70,0.70)',  glow:'#cf9560',  text:'#f2e0c8' },
  // 酒红（孙吴）— H:5° 暗版玩家红，承袭 KOEI 孙吴红传统
  { fill:'rgba(62,18,18,0.82)',   film:'rgba(150,55,50,0.20)',   stroke:'rgba(180,80,75,0.70)',   glow:'#a8504a',  text:'#f0d4d0' },
  // 苍绿（蜀汉）— H:135° 暗版玩家绿，承袭 KOEI 蜀汉绿传统
  { fill:'rgba(15,55,32,0.82)',   film:'rgba(60,135,90,0.20)',   stroke:'rgba(85,160,115,0.70)',  glow:'#5a9466',  text:'#d4ecdb' },
  // 沙金棕（马腾/韩遂系）— H:35° 西凉大漠色，承袭 KOEI 马腾棕色传统
  { fill:'rgba(72,48,18,0.82)',   film:'rgba(175,130,60,0.20)',  stroke:'rgba(200,155,90,0.70)',  glow:'#c89860',  text:'#f0e0c8' },
];
      ...
      if (dutyList.length > 0) {
        const rows = dutyList.map(b => {
          return `<div class="sgt-row sgt-prod-buff">
            ...
            <span class="duty-remain" style="margin-left:auto;color:var(--text-dim);font-size:75%;padding-right:8px">${Number(b.remain) === 0 ? '今日见功' : `剩余 ${_esc(b.remain)} 回合`}</span>
          </div>`;
        }).join('');
