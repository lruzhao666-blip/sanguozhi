...
const NPC_FACTION_COLORS = [
  ...
  // 深海军蓝（曹魏）— H:215° 深暗版，与玩家蓝拉开层级
  { fill:'rgba(8,22,55,0.82)',    film:'rgba(45,75,140,0.20)',   stroke:'rgba(70,100,160,0.70)',  glow:'#2d5288',  text:'#c8d4e8' },
  // 赭石（刘表系）— H:25° 暗赭橙（沿用）
  { fill:'rgba(78,42,12,0.82)',   film:'rgba(180,110,45,0.20)',  stroke:'rgba(205,135,70,0.70)',  glow:'#cf9560',  text:'#f2e0c8' },
  // 干血红（孙吴）— H:5° 深暗版，与玩家红拉开层级
  { fill:'rgba(48,12,8,0.82)',    film:'rgba(115,40,30,0.20)',   stroke:'rgba(140,55,45,0.70)',   glow:'#7a2820',  text:'#e8c8c0' },
  // 苍松墨绿（蜀汉）— H:145° 深暗版，与玩家绿拉开层级
  { fill:'rgba(8,40,22,0.82)',    film:'rgba(40,100,65,0.20)',   stroke:'rgba(60,125,85,0.70)',   glow:'#2d6840',  text:'#c8e0d2' },
