...
<div class="raw-player-anchor with-subtitle">
  ...
  function renderWorld(latest) {
    ...
    if (battlesListEl) {
      if (!battles.length) {
        battlesListEl.innerHTML = '<div class="wb-empty-wrap"><span class="wb-empty-seal">戰</span><span class="wb-empty">本回合无战事</span></div>';
      } else {
    ...
    if (transitListEl) {
      if (!transit.length) {
        transitListEl.innerHTML = '<div class="wb-empty-wrap"><span class="wb-empty-seal">調</span><span class="wb-empty">本回合无调度部队</span></div>';
      } else {
