...
def run():
    with sync_playwright() as p:
        ...
        # Hide the role overlay / auth overlay forcefully
        page.evaluate('''
            const overlay = document.querySelector('.role-overlay');
            if (overlay) overlay.style.display = 'none';
            const authOverlay = document.getElementById('role-overlay');
        ...
        time.sleep(1)
        page.screenshot(path="/home/jules/verification/screenshots/verification_clear.png")
        browser.close()
